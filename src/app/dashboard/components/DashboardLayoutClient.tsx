    ...
    <div className={`h-screen flex flex-col overflow-hidden font-sans antialiased text-[#111827] bg-[#F5F5F5]`}>
      ...
      <header className="sticky top-0 z-40 bg-white h-[60px] shrink-0 select-none">
        <div className="max-w-[1440px] w-full h-full mx-auto px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/dashboard" className="flex items-center group h-10 w-[140px] relative overflow-hidden justify-center">
              <img 
                src="/logo-transparent.png" 
                alt="Safardine" 
                className="w-full h-full object-contain scale-[2.8] origin-center select-none" 
              />
            </Link>
          </div>
      ...
      >
        ...
        <div style={{ display: activeTab === 'analytics' ? 'block' : 'none' }}>
          {analyticsData && <AnalyticsClient {...analyticsData} restaurantId={dashboardData?.restaurantId} menuItems={dashboardData?.menuItems} />}
        </div>
