...
export default function LoginClient({ error, loginAction }: { error?: string; loginAction: (formData: FormData) => Promise<void> }) {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (useRealGoogleOAuth) {
        ...
        // Handle default sign up if user does not exist
        ...
        // Flawless redirect straight into the dashboard!
    ...
    <div className="min-h-screen w-full bg-white font-sans tracking-tight text-slate-700 flex flex-col justify-between items-center py-12 px-4 select-none relative">
      ...
      >
        ...
        <div className="space-y-1">
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">Your AI menu platform.</h1>
          <p className="text-sm font-semibold text-slate-400">Log in to your Safar Dine account</p>
        </div>
        ...
        >
          ...
          <div className="space-y-1.5 text-left">
            ...
            <p className="text-[10px] text-slate-400 font-medium leading-normal">
              Use your restaurant email to easily manage your menu.
            </p>
          </div>
          ...
          <div className="space-y-1.5 text-left">
            <div className="flex justify-between items-center">
              ...
              <Link 
                href="/login" 
                className="text-[9.5px] font-extrabold text-slate-400 hover:text-slate-600 transition-colors uppercase tracking-wider"
              >
                Forgot?
              </Link>
            </div>
          ...
          {/* Action button (Orange Notion-styled button) */}
          <button 
            type="submit"
        ...
        <div className="text-[12.5px] font-bold text-slate-400 pt-1">
          New user?{' '}
          <Link href="/signup" className="text-slate-700 underline hover:text-slate-800 transition-colors">
            Sign up
          </Link>
        </div>
